{
  _config+: {
    ...
    storage_tsdb_storage_backend: 'gcs',
    storage_tsdb_bucket_name: error 'must specify blocks storage bucket name',
    storage_tsdb_s3_endpoint: 's3.dualstack.us-east-1.amazonaws.com',
    ...
    s3BlocksStorageConfig:: $._config.genericBlocksStorageConfig {
      ...
      'experimental.blocks-storage.s3.bucket-name': $._config.storage_tsdb_bucket_name,
      'experimental.blocks-storage.s3.endpoint': $._config.storage_tsdb_s3_endpoint,
    },
    ...
    blocksStorageConfig: (
      if $._config.storage_engine == 'blocks' || $._config.querier_second_storage_engine == 'blocks' then (
        if $._config.storage_tsdb_storage_backend == 'gcs' then $._config.gcsBlocksStorageConfig
        else if $._config.storage_tsdb_storage_backend == 's3' then $._config.s3BlocksStorageConfig
